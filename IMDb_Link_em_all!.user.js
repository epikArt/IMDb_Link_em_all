...
let sites = [
  ...
  // tracker
  {
	ourbits: [
      ...
      'http://ourbits.club/torrents.php?incldead=0&spstate=0&inclbookmarked=0&search={{IMDB_ID}}&search_area=4&search_mode=2',
      'Nothing found!',
      function($dom, resp) {
	...
	chdbits: [
      'CHDBits',
      'https://chdbits.co/favicon.ico',
      'https://chdbits.co/torrents.php?incldead=0&spstate=0&inclbookmarked=0&search={{IMDB_ID}}&search_area=4&search_mode=2',
      'Nothing found!',
      function($dom, resp) {
        if (resp.responseText.indexOf('The page you tried to view can only be used when you\'re logged in.') > -1 || resp.responseText.indexOf('該頁面必須在登錄後才能訪問') > -1) {
          return true;
      ...
      function($dom, resp) {
	   ...
	   ToTheGlory: [
      'TTG',
      'https://totheglory.im/favicon.ico',
      'https://totheglory.im/torrents.php?incldead=1&search={{IMDB_ID}}&search_area=4&search_mode=0',
      'Nothing found!',
      function($dom, resp) {
        if (resp.responseText.indexOf('You need cookies enabled to log in or switch language.') > -1 || resp.responseText.indexOf('你需要启用cookies才能登录或切换语言。') > -1 || resp.responseText.indexOf('你需要啟用cookies才能登錄或切換語言。') > -1) {
          return true;
	   ...
	   hdtime: [
      'HDTime',
      'https://hdtime.org/favicon.ico',
      'https://hdtime.org/torrents.php?incldead=0&spstate=0&inclbookmarked=0&search={{IMDB_ID}}&search_area=4&search_mode=2',
      'Nothing found!',
      function($dom, resp) {
        if (resp.responseText.indexOf('The page you tried to view can only be used when you\'re logged in.') > -1 || resp.responseText.indexOf('該頁面必須在登錄後才能訪問') > -1) {
          return true;
	   ...
	   TorrentCCF: [
      'TCCF',
      'https://et8.org/favicon.ico',
      'https://et8.org/torrents.php?incldead=0&spstate=0&inclbookmarked=0&search={{IMDB_ID}}&search_area=4&search_mode=2',
      'Nothing found!',
      function($dom, resp) {
        if (resp.responseText.indexOf('The page you tried to view can only be used when you\'re logged in.') > -1 || resp.responseText.indexOf('該頁面必須在登錄後才能訪問') > -1) {
          return true;
	...
	BjShare: [
      ...
      'https://bj-share.info/torrents.php?searchstr={{IMDB_TITLE}}+{{IMDB_YEAR}}',
      'Sem resultados.',
      'id="loginform"'
    ],
    cinemageddon: [
    ...
    TehC: [
      'Tehconnection',
      'https://tehconnection.me/favicon.ico',
      'https://tehconnection.me/torrents.php?searchstr={{IMDB_TITLE}}+{{IMDB_YEAR}}',
      'Your search did not match anything',
      'id="loginform"'
    ],
    rarbg: [
    ...
    torrentsmd: [
	  ...
	  'Nici un torrent care corespunde acestui număr IMDB n-a putut fi gasit.',
    ],
    x264: [
      'x264',
    ...
    hdspain: [
      ...
      'https://www.hd-spain.com/index.php?sec=listado&ord=9&b={{IMDB_TITLE}}&ver=0&relanz=0'
    ],
    bithdtv: [
      'BitHDTV',
    ...
    iptorrents: [
      ...
      'https://www.iptorrents.com/torrents/?q={{IMDB_TITLE}}+{{IMDB_YEAR}}',
      'No Torrents Found!',
    ...
    myspleen: [
      ...
      'https://www.myspleen.org/browse.php?search={{IMDB_TITLE}}+{{IMDB_YEAR}}&title=1&cat=0',
      'Nothing found!',
      'MySpleen :: Login'
    ],
    morethantv: [
    ...
    secretcinema: [
      'Secret Cinema',
      'https://secret-cinema.pw/favicon.ico',
      'https://secret-cinema.pw/torrents.php?searchstr={{IMDB_TITLE}}+{{IMDB_YEAR}}',
      'Your search did not match anything.',
      'Lost password'
    ],
    sdbits: [
	...
	Nebulance: [
      'Nebulance',
      'https://nebulance.io/favicon.ico',
      'https://nebulance.io/torrents.php?searchtext={{IMDB_TITLE}}',
      'Your search did not match anything',
      'Login :: NBL'
    ],
	TvVault: [
      'TvVault',
      'https://tv-vault.me/favicon.ico',
      'https://tv-vault.me/torrents.php?searchstr={{IMDB_TITLE}}+{{IMDB_YEAR}}',
      'Nothing found',
      'Login :: TvVault'
    ],
	HDForever: [
      ...
      'https://hdf.world/torrents.php?searchstr={{IMDB_TITLE}}+{{IMDB_YEAR}}',
      'Aucun fichier trouvé.',
      'Login :: HD-Forever'
	],
	DanishBits: [
      'DanishBits',
      'https://danishbits.org/favicon.ico?v=3',
      'https://danishbits.org/torrents.php?action=newbrowse&search=tt{{IMDB_ID}}&pre_type=s_imdb&type=',
      'no found',
      'Login :: DanishBits'
	],
	ruTracker: [
  ...
  // subtitles
  {
    ...
    SUBTITLEINDEX: [
      ...
      'https://subtitle-index.org/subtitles/Movie?query={{IMDB_TITLE}}',
...
let css = '#lta_external_site_links img { margin-right: 4px; vertical-align: middle; }' +
    ...
    '#lta_external_site_links h4 { margin-top: 0.1rem; }' +
    '#lta_external_site_links .links { line-height: 1.3rem; }' +
    '#lta_external_site_links .links .link-wrapper { display: inline-block; }' +
    '#lta_external_site_links .links .link-wrapper .ghost { margin: 0 0.01rem; }' +
    ...
    '#lta_configure_tooltip { color: #333; z-index: 100; font-family: Verdana, Arial, sans-serif; font-size: 10px; padding: 8px 10px; display: block; position: absolute; left: 27px; top: -2px; background-color: rgba(193,193,193,0.97); border-radius: 0px; white-space: nowrap; line-height: 1.5rem; }' +
